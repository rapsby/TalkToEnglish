...
public class ChannelController {
    ...
    public @ResponseBody
    Channel updateChannel(@RequestBody Channel channelJson) {
    ...
    public @ResponseBody
    Schedule updateSchedule(@RequestBody Schedule scheduleJson) {
    ...
    public void syncChannel() {
        ...
        try {
            ...
            urlParameters.add(new BasicNameValuePair("airdate", "2019-03-21"));
            urlParameters.add(new BasicNameValuePair("pk_epg_mapp", ""));
            urlParameters.add(new BasicNameValuePair("fd_mapp_cd", "4003"));
            ...
            for (ChannelInfo channelInfo : channelJSON.getChannelListInfo()) {
                ...
                processSchedule(cookieStore, eChannel, Integer.toString(channelInfo.getFd_channel_id()));
            }
    ...
    private void processSchedule(BasicCookieStore cookieStore, Channel channel, String channelId) {
        try {
            CloseableHttpClient client = HttpClientBuilder.create().setDefaultCookieStore(cookieStore).build();
